...
function FastNotice(props){
  ...
  const [fastNotice, changeFastNotice] = useState([
    ...
    {link:"#", title:"홈페이지 버그 관련 공지", content:"현재 홈페이지는 베타 버전입니다. 만약 홈페이지에 버그가 발생한다면 제보해주시면 빠른 조치 취하겠습니다."},
    {link:"#", title:"합주실 카드키 관련 공지", content:"합주실 카드키는 평일 7시~9시에 공간위실에서 수령 가능합니다."},
