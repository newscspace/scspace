...
class Form extends Component{
    constructor(props){
        ...
        this.props.reserveData : {
            ...
            timeFrom : '',
            timeTo : '',
            content : {organizationName : '', eventName:'', innerNumber : 0, outerNumber : 0, eventPurpose:'',contents:'', rehersalFrom:null, rehersalTo:null, workFrom: null, workTo:null, workComplete:null, equipment:[], food:'', lobby:[], desk:0, chair:0}
        }
