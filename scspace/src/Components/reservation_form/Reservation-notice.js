...
class ReservationNotice extends Component {
  constructor(props) {
    ...
    this.state = {
      notice: [
        { title: '회칙 및 약관을 잘 확인해주세요.', contents: '홈페이지 소개 페이지에서 회칙 및 공간위 통합 약관 확인이 가능합니다. 회칙을 잘 읽고 예약해주세요.' },
        { title: '예약 현황을 확인해주세요.', contents: '홈페이지 예약 현황에서 공간의 예약 상황을 확인할 수 있습니다. 예약 현황 확인 후 예약해주세요.' },
