...
class Header extends Component {
  ...
  onClickEvent2 = (idx, e) => {
    document
      ...
      .classList.toggle("bi-chevron-up");
    document
      .querySelector("#" + "button" + idx)
      .classList.toggle("bi-chevron-down");
    document
      .querySelector("#" + "ul" + idx)
            ...
            <ul>
              {this.state.menu.map((menu, idx) => {
                return menu.sub_menu.length === 0 ? (
                  <li keys={idx}>
                    <Link className="nav-link scrollto" to={menu.menu_link}>
                      {t(menu.name)}
                    </Link>
                  </li>
                ) : (
                  <li
                    ...
                    onClick={this.onClickEvent2.bind(this, idx)}
                  >
                    ...
                    <ul id={"ul" + idx} className="">
                      <li>
                        {menu.sub_menu.map((sub_name, idx2) => {
                          return (
                            <Link to={menu.sub_menu_link[idx2]}>
                              {t(sub_name)}
                            </Link>
                          );
                        })}
          ...
          {this.state.login === true ? (
            <Dropdown>
              ...
              <Dropdown.Menu>
                ...
                {this.state.UserInfo.type === "admin" ? (
